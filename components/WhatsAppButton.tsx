...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-[#2ee88a] to-[#0fa968] shadow-[0_10px_30px_-8px_rgba(46,232,138,0.6)] transition-transform hover:scale-110"
    >
      <svg width="26" height="26" viewBox="0 0 24 24" fill="#04120a">
